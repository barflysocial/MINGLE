...
function render() {
  ...
  showApp();
  $('playerTitle').textContent = `${state.player.avatarName} • User Mode`;
...
function renderProfileCard() {
  ...
  $('myAvatarMeta').textContent = state.player.liveVerified
    ? 'Your system-assigned avatar name cannot be changed. Your cartoon avatar is public first. Your real photo stays hidden until mutual reveal.'
...
$('joinForm').addEventListener('submit', async (e) => {
  ...
  try {
    ...
    state.question = data.question;
    state.match = null;
    showMessage('joinMsg', `Your assigned avatar name is ${data.player.avatarName}. Next step: take your live selfie.`, true);
    render();
  } catch (err) {
